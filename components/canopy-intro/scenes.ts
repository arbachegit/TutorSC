...
export const SCENES: CanopyScene[] = [
  { bg: '#e0d4eb', hero: 'Aula no seu nível, em qualquer assunto', mockup: 'prompt', promptText: 'Me explique regra de três com exemplo do dia a dia', hold: HOLD },
  { bg: '#f3ecdc', hero: 'Pode ficar mais simples. Ou mais científica.',          mockup: 'prompt', promptText: 'Quero algo mais difícil — sou de engenharia', hold: HOLD },
